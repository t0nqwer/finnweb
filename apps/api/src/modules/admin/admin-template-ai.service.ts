...
export class AdminTemplateAiService {
  ...
  private buildPrompt(
    ...
    return [
      ...
      "8) For education/course websites, prefer a DevOnMars-like composition: sticky navbar, editorial hero, metrics, featured courses, bento features, categories, testimonials, FAQ, CTA/contact, large footer.",
      "",
      "Return strictly as:",
