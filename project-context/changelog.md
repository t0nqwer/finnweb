...
- Coverage: 46 engine + 10 template-gate + 21 generator + 5 admin validator tests pass, `pnpm typecheck` passes. `sites.integration.test.ts` could not be run here — it needs the remote dev database, which is unreachable from this machine.
